...
// #include "f23E.cin"
 ...
 FILE *o;o=fopen("exc2cuts.eps","w");  ado(o,214,212);
...
fprintf(o,"showpage\n\%\%\%Trailer"); fclose(o);
//	system(      "gv exc2cuts.eps &"); //for UNIX
 //	system(    "open exc2cuts.eps"); //for macintosh
 	system("epstopdf exc2cuts.eps"); 
 	system(    "xpdf exc2cuts.pdf"); // for LINUX
