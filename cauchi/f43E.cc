...
//#include "uq2e3.cin"
 ...
 FILE *o;o=fopen("f43E.eps","w");  ado(o,214,212);
...
//M(-10,0)L(-2,0)fprintf(o,".04 W 1 0 1 RGB S\n");
 fprintf(o,"showpage\n\%\%\%Trailer"); fclose(o);
 //	system(      "gv f43E.eps &"); //for UNIX
 //	system(    "open f43E.eps"); //for macintosh
 	system("epstopdf f43E.eps"); 
 	system(    "xpdf f43E.pdf"); // for LINUX 
