...
/////////////////////////////////////
 ...
 FILE *o;o=fopen("f45L.eps","w");  ado(o,214,212);
...
M(4, 0)L(-11.,0)	fprintf(o,".08 W 1 1 1 RGB S\n");
DO(n,48){M(4-.3*n, 0)L(4-.3*(n+.5),0)}
 					fprintf(o,".1 W 0 0 0 RGB S\n");

 fprintf(o,"showpage\n\%\%\%Trailer"); fclose(o);
// 	system(    "open f45L.eps"); //for macintosh
 	system("epstopdf f45L.eps"); 
 	system(    "xpdf f45L.pdf"); // for LINUX 
